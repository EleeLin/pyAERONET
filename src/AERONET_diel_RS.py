...
seasons_mon = [['12', '01', '02'], ['03', '04', '05'], ['06', '07', '08'], ['09', '10', '11']]

# regions
regions = ['West', 'Central', 'East']
regions_pos = [[-125.0, -104.7, 25.0, 49.0], [-104.7, -85.3, 25.0, 49.0], [-85.3, -66.0, 25.0, 49.0]]
...
for rr in range (0, len (regions)):
    for ss in range (0, len (seasons)):
        ...
        outfile = open ('./diel_' + regions [rr] + '_' + seasons [ss] + '.csv', 'w')
        with outfile:
